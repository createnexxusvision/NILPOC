...
contract ClipRevenueSplitter is Ownable, ReentrancyGuard {
    ...
    function updateClipContributors(
        ...
        // Clear previous contributors by simply overwriting up to old count
        // and updating the contributorCount to the new length.
        uint16 oldCount = c.contributorCount;
        c.contributorCount = uint16(wallets.length);
